...
module RubyNeuralNets
  ...
  module DataLoaders
    ...
    class NumoVips < DataLoader
      ...
      def initialize(datasets_path:, dataset:, max_minibatch_size:, dataset_seed:, partitions:, nbr_clones:, rot_angle:, grayscale:, adaptive_invert:, trim:, resize:, noise_intensity:, minmax_normalize:, filter_dataset:)
