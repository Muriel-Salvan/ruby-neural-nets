...
<description>Loads and enforces all mandatory project skills. What this does is load all mandatory skills. Use this when starting any task. Use this skill also in Plan mode.</description>
<location>project</location>
</skill>
